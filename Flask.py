...
def home_page():
    return render_template("coffeeco_home.html", subtitle="Home")
...
def order_page():
    ...
    return render_template("coffeeco_order.html", subtitle="Order")


@app.route('/coffee.co/menu')
def menu_page():
    return render_template("coffeeco_menu.html", subtitle="Menu")


@app.route('/coffee.co/account')
def account_page():
    return render_template("coffeeco_account.html", subtitle="Account")
...
def locations_page():
    return render_template("coffeeco_locations.html", subtitle="Location")
